 ...
 *   https://datatables.net/download/#dt/dt-1.11.3/date-1.1.1/fh-3.2.0/r-2.2.9/sp-1.4.0
 *
 * Included libraries:
 *   DataTables 1.11.3, DateTime 1.1.1, FixedHeader 3.2.0, Responsive 2.2.9, SearchPanes 1.4.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.11.3/date-1.1.1/fh-3.2.0/r-2.2.9/sp-1.4.0",
